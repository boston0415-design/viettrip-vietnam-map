const CONFIG={
  categories:{
    restaurant:{label:'식당',subs:['한식','일식','베트남','중식','양식','기타']},
...
const RESTAURANT_TAGS=['고기·구이','해산물','채식','야식','오마카세','브런치'];
...
const EXTRA_DATA={
  hcmc:{
    ...
    points:[
      ...
      {name:'일반택시 · Xanh SM 승차 · T3',type:'택시승차',lat:10.81172,lng:106.65386,icon:'TAXI',desc:'T3 도착층 인근 지정 택시 승차 구역. 현장 표지와 앱 안내를 우선하세요.'},
      ...
      {name:'일반택시 · Xanh SM 승차 · T2 국제선',type:'택시승차',lat:10.81615,lng:106.66340,icon:'TAXI',desc:'떤선녓 T2 국제선 도착층 택시·전기택시 지정 승차구역. 실제 승차 위치는 현장 표지와 앱 안내를 우선하세요.'},
