const CONFIG={
  categories:{
    ...
    shopping:{label:'쇼핑',subs:['마트','쇼핑몰','백화점','아울렛','과일가게','꽃집']},
...
const EXTRA_DATA={
  hcmc:{
    ...
    points:[
      ...
      {name:'사이공역',type:'기차역',lat:10.781213,lng:106.677198,address:'1 Nguyễn Thông, Nhiêu Lộc, Ho Chi Minh City, Vietnam',icon:'R',desc:'호치민에서 남북선 열차를 타는 사이공역(Ga Sài Gòn)입니다. 기차표 예약에서 출발역 Sài Gòn, 도착역과 날짜를 선택하세요.',locationNote:'지도 핀은 역의 대표 위치입니다. 1 Nguyễn Thông의 역 출입구로 들어가 전광판에서 열차번호·승차홈을 확인하세요.',sourceUrl:'https://vr.com.vn/',sourceLabel:'베트남철도 공식 홈페이지',locationSourceUrl:'https://vi.wikipedia.org/wiki/Ga_S%C3%A0i_G%C3%B2n',verifiedOn:'2026-09-18'},
