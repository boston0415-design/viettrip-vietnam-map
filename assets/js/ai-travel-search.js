...
(() => {
  ...
  function routeCards(t){
    ...
    add('bus',{title:island?'버스 + 항구 이동':'버스·리무진',description:island?'푸꾸옥은 섬이므로 육로 구간과 배편을 나누어 확인해야 합니다. 항구·배편과 연결되는 버스인지 예약처에 확인하세요.':'출발지 '+cities[o][0]+', 도착지 '+cities[d][0]+'와 날짜를 선택해 노선을 확인하세요. 예약 사무실과 실제 승차장은 다를 수 있고, 차량 등급·픽업 방식은 편마다 다릅니다.',links:[['FUTA 노선·차량·요금 확인',URLS.bus]],places:[[cities[o][0]+' 버스 예약처 찾기','FUTA Phuong Trang '+cities[o][1]],[cities[d][0]+' 버스터미널 찾기','bus station '+cities[d][1]]],candidate:true});
    if(dalat){
