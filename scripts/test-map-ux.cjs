...
window.google={maps:{Marker:TestMarker,Circle:TestMarker,Size:class{},Point:class{},event:{trigger:empty},places:{AutocompleteSessionToken:class{},AutocompleteService:class{getPlacePredictions(r,cb){window.lastAutocompleteQuery=r.input;cb([{place_id:'external-ux',structured_formatting:{main_text:'검색한 새 업소',secondary_text:'호치민 주소'}}],'OK')}},PlacesService:class{getDetails(r,cb){cb({place_id:r.placeId,name:r.placeId==='flower-google'?'Blossom 꽃집':r.placeId==='google-wax-a'?'Waxing A':'검색한 새 업소',formatted_address:'정확한 주소',geometry:{location:{lat:()=>10.775,lng:()=>106.705}},types:r.placeId==='flower-google'?['florist','store']:['cafe'],formatted_phone_number:'+84 123 456 789',website:r.placeId==='flower-google'?'https://flower.fixture.invalid':undefined,opening_hours:{weekday_text:['월요일 09:00–21:00'],isOpen:()=>true},rating:4.5,user_ratings_total:22},'OK')}findPlaceFromQuery(r,cb){cb([],'ZERO_RESULTS')}}}}};
