...
export async function onRequest(context){
  ...
  for(const [model,tokens,timeout] of [['@cf/zai-org/glm-4.7-flash',2400,15000],['@cf/openai/gpt-oss-120b',2400,10000]]){
    let timer;
    try{
